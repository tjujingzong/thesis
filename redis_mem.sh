...
benchmark_cmd="redis-benchmark -h $host -p $port -t set -c 50 -n 20000 -d 128"
...
for mem in ${memory_levels[@]}; do
    ...
    stress-ng --vm 2 --vm-bytes $mem --timeout $benchmark_duration &
    ...
    echo "mem $mem" >>$benchmark_result_file
    pkill stress-ng
